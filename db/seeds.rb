...
Source.create(name: 'The New York Times Technology Top Stories')
...
# User.destroy_all
User.create(username: 'seacen', first_name: 'Xichang', last_name: 'Zhao', interest_list: 'seacen, china', email: 'xichangzhao@outlook.com', password: 'seacen', subscribed: true)
